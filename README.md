...
![alt tag](https://github.com/altamira/IHM_HTML/blob/master/project idea with node-red.png)

#Jquery Page
![alt tag](https://github.com/altamira/IHM_HTML/blob/master/HMI.png)

#Node-Red flow
![alt tag](https://github.com/altamira/IHM_HTML/blob/master/flow node-red.png)
